...
SELECT * FROM webDevelopment.languages EXCEPT 
SELECT * FROM webDevelopment.languages WHERE languages ='PHP';

--ex7: Dans la table languages,afficher toutes les données par ordre alphabétique.
SELECT * FROM webDevelopment.languages ORDER BY languages;
